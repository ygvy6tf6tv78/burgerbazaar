    ...
    >
      <div className="section-shell section-shell-light">
        <div className="section-shell-inner p-6 text-center">
          <div className="absolute right-0 top-0 h-28 w-28 rounded-full bg-[#D8C3A5]/25 blur-3xl" />

          <div className="flex items-center justify-center gap-4 mb-5">
            <div className="w-20 h-20 bg-white rounded-[22px] flex items-center justify-center shadow-[0_18px_34px_rgba(15,23,42,0.1)] border border-[#D8C3A5]/30 overflow-hidden">
              <Image
          ...
          <div className="space-y-3">
            {shopConfig.social?.instagram && (
              ...
              >
                ...
                <span className="text-[15px] font-semibold tracking-tight">Follow @the.sonnet.cafe</span>
              </motion.button>
            )}
          </div>
        </div>
